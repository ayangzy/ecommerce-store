...
trait ApiResponses
{
    ...
    public function serverErrorAlert($message, Throwable $exception = null): JsonResponse
    {
        ...
        $response = [
            'statusCode' => config('store.status_codes.server_error'),
            'statusText' => config('store.status_texts.server_error'),
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.server_error'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.validation_failed'),
            'statusText' => config('store.status_texts.validation_failed'),
        ...
        return Response::json($response, config('store.status_codes.validation_failed'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.not_found'),
        ...
        return Response::json($response, config('store.status_codes.not_found'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.bad_request'),
            'statusText' => $statusText,
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.bad_request'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.success'),
            'statusText' => config('store.status_texts.success'),
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.success'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.created'),
            'statusText' => config('store.status_texts.created'),
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.created'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.forbidden'),
            'statusText' => config('store.status_texts.forbidden'),
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.forbidden'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.unauthorised'),
            'statusText' => config('store.status_texts.unauthorised'),
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.unauthorised'));
    }
    ...
    {
        $response = [
            'statusCode' => config('store.status_codes.conflicted'),
            'statusText' => $statusText,
            'message' => $message,
        ];
        ...
        return Response::json($response, config('store.status_codes.conflicted'));
    }
}
